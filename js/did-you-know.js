...
(function () {
  ...
  var css = [
    ...
    '  background: linear-gradient(160deg, #F6F4EF 0%, #ECE8DF 100%);',
    '  border: 1px solid rgba(18, 49, 76, 0.12);',
    '  border-top: 3px solid #B9A77E;',
    '  border-radius: 14px;',
    '  box-shadow: 0 18px 48px rgba(18, 49, 76, 0.22);',
    ...
    '  background: #FFFFFF; border: 1px solid rgba(78, 110, 74, 0.35);',
    '  object-fit: cover; flex-shrink: 0;',
    '}',
    '.dyk-eyebrow {',
    '  font-size: 0.68rem; letter-spacing: 0.14em; text-transform: uppercase;',
    '  color: #B9A77E; font-weight: 700; margin: 0 0 2px;',
    '}',
    '.dyk-title { font-size: 1.05rem; font-weight: 700; color: #12314C; margin: 0; line-height: 1.2; }',
    '.dyk-body { font-size: 0.86rem; line-height: 1.55; color: #33475C; margin: 0 0 12px; }',
    '.dyk-body strong { color: #12314C; }',
    '.dyk-body em { color: #4E6E4A; font-style: italic; }',
    '.dyk-link {',
    '  display: inline-block; font-size: 0.82rem; font-weight: 600;',
    '  color: #4E6E4A; text-decoration: none; border-bottom: 1px solid rgba(78, 110, 74, 0.4);',
    '  padding-bottom: 1px;',
    '}',
    '.dyk-link:hover { color: #12314C; border-bottom-color: #B9A77E; }',
    '.dyk-close {',
    '  position: absolute; top: 10px; right: 12px;',
    '  background: none; border: none; cursor: pointer;',
    '  font-size: 1.15rem; line-height: 1; color: rgba(18, 49, 76, 0.45);',
    '  padding: 4px;',
    '}',
    '.dyk-close:hover { color: #12314C; }',
